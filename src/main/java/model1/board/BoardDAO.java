...
public class BoardDAO extends JDBConnect {
	...
	//부모의 인자생성자를 호출한다 + application 내장객체를 매개변수로 전달
	public BoardDAO(ServletContext application) {
		//내장객체를 통해 web.xml에 작성된 컨텍스트초기화파라미터를 얻어와 DB연결
		super(application);
	}
	...
	public int selectCount(Map<String, Object> map) {
		...
		try {
			...
			//select쿼리문을 실행후 ResultSet 객체를 반환
	...
	/*
	목록에 출력할 게시물을 오라클로부터 추출하기 위한 쿼리문 실행 (페이지처리x)
	 */
	public List<BoardDTO> selectList(Map<String, Object> map){
		...
		역순(내림차순)으로 정렬해야 한다. 게시판의 목록은 최신 게시물이
		제일 앞에 노출되기 때문이다.
		 */
	...
	/*
	목록에 출력할 게시물을 오라클로부터 추출하기 위한 쿼리문 실행 (페이지처리O)
	 */
	...
	//게시물 수정 메서드 : 수정할 내용을 DTO객체에 저장후 매개변수로 전달
