...
//어노테이션을 통한 요청명 매핑 (항상 컨텍스트루트 경로를 제외한 '/'로 시작하는 경로명!)
...
public class NaverSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//네이버개발자센터에서 발급받은 API Key입력
		String clientId = "XoScdr88u0UqDYg60m1H"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "n1Wqkkp8MP"; //애플리케이션 클라이언트 시크릿값"
