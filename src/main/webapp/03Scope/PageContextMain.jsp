...
page영역
	...
	포워드 된 모든 페이지에서는 영역이 소멸되어 공유되지 않는다.
...
/*
	...
	Object 기반으로 차후 값을 읽을 때는 해당 형으로 변환해야 한다.
*/
%>
<!DOCTYPE html>
<html>
...
<body>
	...
	<% 
	//정수데이터를 객체화할 때 Interger클래스를 통해 박싱/언박싱 할 수 있다.
	...
	<ul>
		<!-- Java의 기본클래스인 경우 별도의 처리없이 즉시 내용을 출력할수 있다. -->
	...
	포함시킨 후 컴파일을 진행한다. 따라서 같은페이지라 보면된다.
	 -->
