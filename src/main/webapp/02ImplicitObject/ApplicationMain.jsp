...
<body>
	...
	<!-- 
		이클립스에서는 우리가 직접 작성한 파일을 실행하는 것이 아니고
		metadata폴더 하위에 프로젝트와 동일한 환경을 만들어서 복사본 파일이
		실행된다. 따라서 아래의 물리적 경로는 metadata하위의 경로가 출력되게 된다.
	 -->
	<h2>서버의 물리적경로 얻어오기</h2>
	...
	내장객체는 _jspService()메서드내에서 생성된 지역변수이므로 더 넓은 
	지역인 선언부에서 사용하려면 매개변수로 전달받아야 한다.
	*/
	...
	public String useImplicitObject(ServletContext app) {
		/*
		방법2 : 스트립트릿에서 메서드 호출 시 application 내장객체를
			매개변수로 전달해서 사용한다
		*/
