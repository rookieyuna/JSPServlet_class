...
<body>
<!-- 
	폼값이나 파라미터를 받을 때 El의 내징객체를 사용할 수 있다.
 ...
 -->
	...
	/*
	JSP내장객체를 통해 폼값을 받은 후 출력하는 경우 선택된 값이 출력개수와
	맞지 않을 경우 NullPointerExeption 에러가 발생하게된다.
	이 경우 if문으로 값이 있는지 체크하거나 예외처리를 해야하므로 EL에 비해 불편하다.
	*/
	%>
