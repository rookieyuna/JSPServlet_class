...
<body>
	...
	<!-- 
		만약 영역명 지정없이 속성을 읽을때는 가장 좁은 영역을 우선 출력
		즉, 여기서 가장 좁은 영역인 page속성을 출력하게 됨
		실무에서는 동일한 속성명으로 저장하는 경우는 거의없어서 대부분 이렇게 쓴다.
	 -->
