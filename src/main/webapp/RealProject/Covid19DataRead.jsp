...
$(function() {
	...
	$('#submitBtn').click(function(){
		...
		/*
		/-/g 와 같은 정규표현실을 사용하면 문자열 내 모든 하이픈을 제거해준다.
		정규표현식을 쓰지않으면 앞에 있는 하이픈하나만 제거된다.
		*/
		//여기에서 공공데이터 API요청
		$.ajax({
			data : {
...
<div class="container">
	...
	<form action="">
		...
		<input class="btn btn-danger" type="button" id="submitBtn" value="요청하기"/>
	</form>
	<div id="resultShow">
