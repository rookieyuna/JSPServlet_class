...
$(document).ready(function(){
	...
	$('#goodsOptionId01').change(function() {
		$.ajax({
			...
			success: function(d) {
				//totalPrice(hidden태그 id) value값을 얻어온다
...
//썸네일 이미지에 마우스 오버시 대표이미지 변경되는 함수
   		 ...
   		 <tr>
   			 ...
   			 <td>
   				 <select id="goodsOptionId01">
   					 <option value="" disabled selected>선택하삼</option>
